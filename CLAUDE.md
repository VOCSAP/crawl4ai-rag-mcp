...
| `INDEX_JOB_HEARTBEAT_SECONDS` | Période du heartbeat pendant le travail. Doit rester bien sous `INDEX_JOB_STALE_SECONDS`, sinon un job sain est déclaré `lost` | `30` |
